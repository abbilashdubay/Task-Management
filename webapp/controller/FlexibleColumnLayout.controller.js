sap.ui.define([
	...
	return BaseController.extend("com.vistex.taskmanagement.controller.FlexibleColumnLayout", {
		onInit: function () {
		...
		onBeforeRouteMatched: function(oEvent) {
			...
			if (this.currentRouteName === "master") { // last viewed route was master
				var oLoginView = this.oRouter.getView("com.vistex.taskmanagement.view.Login");
