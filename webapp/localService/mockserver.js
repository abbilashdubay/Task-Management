sap.ui.define([
	...
	var _sAppPath = "com/vistex/taskmanagement/",
			...
			return new Promise(function(fnResolve, fnReject) {
				...
				oManifestModel.attachRequestCompleted(function () {
					var sJsonFilesUrl = sap.ui.require.toUrl(_sJsonFilesPath),
						oMainDataSource = oManifestModel.getProperty("/sap.app/dataSources/taskManagementRemote"),    //load taskManagement model from manifest
